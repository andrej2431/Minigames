...
# create pieces
def block(color,x,y):
    canvas.create_rectangle(x,y,x+20,y+20, fill=color,tags='moving')
...
def taken(number):
    ...
    for row in canvas.find_withtag('moving'):
        ...
        there = canvas.find_enclosed(cords_1[0]-number*y_dif-1,cords_1[1]+number*x_dif-1,cords_1[0]-number*y_dif+21,cords_1[1]+number*x_dif+21)
...
#game over
def game_over():
    for row in canvas.find_overlapping(39,0,119,19):
        if not canvas.gettags(row):
            return True
    return False
#turn
def clock_turn():
    if shape != 'yellow' and shape!='cyan':
        ...
        for row in canvas.find_withtag('moving'):
            ...
            if x_dif == 20:
                if len(canvas.find_enclosed (cords_1[0] - 20, cords_1[1] - 20, cords_1[0], cords_1[1] + 60)) > 1 or cords_1[1] > 360:
                    return
                
            if x_dif == -20:
                if len(canvas.find_enclosed (cords_1[0] + 20, cords_1[1] - 40, cords_1[0] + 40, cords_1[1] + 40)) > 1 or cords_1[1] > 380:
                    return
                
            if y_dif == 20:
                if len(canvas.find_enclosed (cords_1[0] - 40, cords_1[1] - 20, cords_1[0] + 40, cords_1[1])) > 1 or cords_1[0] > 160 or cords_1[0] < 40:
                    return
                
            if y_dif == -20:
                if len(canvas.find_enclosed (cords_1[0] - 20, cords_1[1] + 20, cords_1[0] + 60, cords_1[1] + 40)) > 1 or cords_1[0] > 140 or cords_1[0] < 20:
                    return
...
def counter_clock_turn():
    if shape != 'yellow' and shape!='cyan':
        ...
        for row in canvas.find_withtag('moving'):
            ...
            if x_dif == 20:
                if len(canvas.find_enclosed (cords_1[0] - 40, cords_1[1] - 20, cords_1[0] - 20, cords_1[1] + 60)) > 1 or cords_1[1] > 360:
                    return
                
            if x_dif == -20:
                if len(canvas.find_enclosed (cords_1[0] + 40, cords_1[1] - 40, cords_1[0] + 60, cords_1[1] + 40)) > 1 or cords_1[1] > 380:
                    return
                
            if y_dif == 20:
                print (cords_1[0])
                if len(canvas.find_enclosed (cords_1[0] - 40, cords_1[1] - 40, cords_1[0] + 40, cords_1[1] - 20)) > 1 or cords_1[0] > 160 or cords_1[0] < 40:
                    return
                
            if y_dif == -20:
                if len(canvas.find_enclosed (cords_1[0] - 20, cords_1[1] + 40, cords_1[0] + 60, cords_1[1] + 60)) > 1 or cords_1[0] > 140 or cords_1[0] < 20:
                    return
