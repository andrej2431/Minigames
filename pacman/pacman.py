...
def ghost(color,x,rx=0,ry=0):
    ...
    canvas.create_polygon (243+x,297, 244+x,297, 244+x,296, 245+x,296, 245+x,295, 246+x,295, 246+x,296, 247+x,296, 247+x,297, 249+x,297,
                           249+x,295, 251+x,295, 251+x,297, 253+x,297, 253+x,296, 254+x,296, 254+x,295, 255+x,295, 255+x,296, 256+x,296,
                           256+x,297, 257+x,297, 257+x,289, 256+x,289, 256+x,286, 255+x,286, 255+x,285, 254+x,285, 254+x,284, 252+x,284,
                           252+x,283, 248+x,283, 248+x,284, 246+x,284, 246+x,285, 245+x,285, 245+x,286, 244+x,286, 244+x,289, 243+x,289,
...
def food():
    ...
    for x in range (20,540,20):
        for y in range (20,600,20):
            if (str(x) not in x_clear or str(y) not in y_clear) and len(canvas.find_overlapping(x,y,x+20,y+20)) == 0 :
...
def color_change(color):
    ...
    canvas.create_rectangle(ghost[0]+4,ghost[1]-9,ghost[0]+6,ghost[1]-7,fill = 'peach puff', tags = [color,'good','nomnom'],width = 0)
    canvas.create_rectangle(ghost[0]+8,ghost[1]-9,ghost[0]+10,ghost[1]-7,fill = 'peach puff', tags = [color,'good','nomnom'],width = 0)
    
    canvas.create_rectangle(ghost[0]+1,ghost[1]-4,ghost[0]+2,ghost[1]-3,fill = 'peach puff', tags = [color,'good','nomnom'],width = 0)
    
    canvas.create_rectangle(ghost[0]+2,ghost[1]-5,ghost[0]+4,ghost[1]-4,fill = 'peach puff', tags = [color,'good','nomnom'],width = 0)
    
    canvas.create_rectangle(ghost[0]+4,ghost[1]-4,ghost[0]+6,ghost[1]-3,fill = 'peach puff', tags = [color,'good','nomnom'],width = 0)
    
    canvas.create_rectangle(ghost[0]+6,ghost[1]-5,ghost[0]+8,ghost[1]-4,fill = 'peach puff', tags = [color,'good','nomnom'],width = 0)
    
    canvas.create_rectangle(ghost[0]+8,ghost[1]-4,ghost[0]+10,ghost[1]-3,fill = 'peach puff', tags = [color,'good','nomnom'],width = 0)
    
    canvas.create_rectangle(ghost[0]+10,ghost[1]-5,ghost[0]+12,ghost[1]-4,fill = 'peach puff', tags = [color,'good','nomnom'],width = 0)
    
    canvas.create_rectangle(ghost[0]+12,ghost[1]-4,ghost[0]+13,ghost[1]-3,fill = 'peach puff', tags = [color,'good','nomnom'],width = 0)
